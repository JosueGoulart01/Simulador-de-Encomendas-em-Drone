    ...
    <div className="relative flex h-dvh flex-col bg-background">
      ...
      <div className="relative z-10 flex h-full flex-col">
        ...
        <main className="flex flex-1 flex-col gap-3 overflow-hidden p-3 lg:flex-row lg:gap-4 lg:p-4">
          ...
          <section className="flex min-h-0 flex-1 flex-col gap-3 lg:min-w-[60%]">
            <KpiCards />
          ...
          {/* Barra lateral - largura fixa e altura total */}
          <aside className="flex w-full min-h-0 flex-col rounded-lg border border-border bg-card/70 p-3 backdrop-blur-sm lg:w-[340px] lg:shrink-0">
            <SidebarPanel />
          </aside>
        </main>

        <footer className="flex items-center justify-between border-t border-border px-4 py-1.5 text-[10px] text-muted-foreground">
